...
ggInterval_2Dhist <- function(data = NULL,
  ...
  with(data, {
    ...
    myTable <- rbind(myTable, c(s2, n, " "), c(round(s2 / n, 3), " ", 1))
    
    rownames(myTable) <- c(rNames,
                           paste0("Frequency of ", attr1),
                           paste0("Margin of ", attr1))
    colnames(myTable) <- c(cNames,
                           paste0("Frequency of ", attr2),
                           paste0("Margin of ", attr2))
